package elalto.gamea.yayo.map_yayo;
...
public class MapYayoActivity extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_yayo);
        ButterKnife.bind(this);
        toolbar.setTitle("DONDE SE EXTRAVIO.?");
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        MapYayoActivity.this.mapboxMap = mapboxMap;

        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            @Override
            public void onStyleLoaded(@NonNull Style style) {
                enableLocationPlugin(style);
                hoveringMarker = new ImageView(MapYayoActivity.this);
